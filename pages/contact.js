        ...
        <div className="relative z-10 flex flex-col items-start justify-start p-10 bg-white shadow-2xl rounded-xl">
           <form ref={form} onSubmit={sendEmail} className="relative w-full mt-6 space-y-8">
              ...
              <div className="relative">
                 ...
                 <textarea name="message" required minLength="5" className="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="Salutations!"/>
              </div>
